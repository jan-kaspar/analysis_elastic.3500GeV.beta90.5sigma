...
double al_a_L_F = -0.05E-3, al_b_L_F = -7.2E-3, al_c_L_F =  +71E-3;
double al_a_L_N = -1.69E-3, al_b_L_N = -8.2E-3, al_c_L_N =    0E-3;
double al_a_R_N = +1.93E-3, al_b_R_N = -4.3E-3, al_c_R_N = -140E-3;
double al_a_R_F = -0.25E-3, al_b_R_F = -5.9E-3, al_c_R_F = -187E-3;
...
void Init_45b_56t()
{
	...
	//th_x_al_L = +0.8E-6; th_x_be_L = -0.149;
	//th_x_al_R = +2.0E-6; th_x_be_R = +0.162;
	...
	cut6_a = 0.1073; cut6_b = -3.4E-3; cut6_si = 17E-3;

	cut7_al = -13.1;
	cut7_c = 0E-3;	// now included in fine alignment
	cut7_si = 9E-3;

	th_y_lcut_L = 24.5E-6; th_y_lcut_R = 23.5E-6;	
	th_y_hcut_L = 107E-6; th_y_hcut_R = 103E-6;

	si_th_x_er = 4.60E-6;

	reco_eff_corr = 1.090; reco_eff_corr_unc = 0.004;
	full_eff_corr = 1.171;
...
void Init_45t_56b()
{
	...
	//th_x_al_L = +1.0E-6; th_x_be_L = -0.104;
	//th_x_al_R = +1.6E-6; th_x_be_R = +0.194;
	th_x_al_L = +0.; th_x_be_L = -0.;	// now included in fine alignment
	th_x_al_R = +0.; th_x_be_R = +0.;
	...
	cut5_a = 0.1073; cut5_b = +0.7E-3; cut5_si = 17E-3;
	cut6_a = 0.1073; cut6_b = 4.10E-3; cut6_si = 17E-3;

	cut7_al = -16.1;
	cut7_c = 0E-3;	// now included in fine alignment
	cut7_si = 9E-3;

	th_y_lcut_L = 24.0E-6; th_y_lcut_R = 23.5E-6;	
	th_y_hcut_L = 109E-6; th_y_hcut_R = 107E-6;

	si_th_x_er = 4.35E-6;
	
	reco_eff_corr = 1.088; reco_eff_corr_unc = 0.004;
	full_eff_corr = 1.145;
