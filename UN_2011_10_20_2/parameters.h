...
double al_a_L_F = -0.05E-3, al_b_L_F = -14.0E-3, al_c_L_F = +113E-3;
double al_a_L_N = -1.69E-3, al_b_L_N = -14.8E-3, al_c_L_N =  +50E-3;
double al_a_R_N = +1.93E-3, al_b_R_N = -14.5E-3, al_c_R_N = -173E-3;
double al_a_R_F = -0.40E-3, al_b_R_F = -14.0E-3, al_c_R_F = -227E-3;
...
void Init_45b_56t()
{
	...
	cut6_a = 0.1073; cut6_b = -4.7E-3; cut6_si = 17E-3;
	
	cut7_al = -13.1;
	cut7_c = 0E-3;	// now included in fine alignment
	cut7_si = 9E-3;

	th_y_lcut_L = 21.5E-6; th_y_lcut_R = 21.0E-6;
	th_y_hcut_L = 107E-6; th_y_hcut_R = 103E-6;

	si_th_x_er = 4.60E-6;
	
	reco_eff_corr = 1.099; reco_eff_corr_unc = 0.014;
	full_eff_corr = 1.212;
...
void Init_45t_56b()
{
	...
	cut5_a = 0.1073; cut5_b = -4.0E-3; cut5_si = 17E-3;
	cut6_a = 0.1073; cut6_b = +7.0E-3; cut6_si = 17E-3;
	
	cut7_al = -12.8;
	cut7_c = 0E-3;	// now included in fine alignment
	cut7_si = 9E-3;

	th_y_lcut_L = 21.2E-6; th_y_lcut_R = 20.6E-6;
	th_y_hcut_L = 109E-6; th_y_hcut_R = 107E-6;

	si_th_x_er = 4.35E-6;
	
	reco_eff_corr = 1.098; reco_eff_corr_unc = 0.014;
	full_eff_corr = 1.166;
