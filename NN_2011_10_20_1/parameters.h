...
double al_a_L_F = -0.05E-3, al_b_L_F = -7.2E-3, al_c_L_F = -26E-3;
double al_a_L_N = -1.69E-3, al_b_L_N = -8.2E-3, al_c_L_N = -97E-3;
double al_a_R_N = +1.93E-3, al_b_R_N = -4.3E-3, al_c_R_N = -42E-3;
double al_a_R_F = -0.25E-3, al_b_R_F = -5.9E-3, al_c_R_F = -73E-3;
...
void Init_45b_56t()
{
	...
	cut1_si = 9.2E-6; cut1_c = +0.3E-6;
	cut2_si = 3.5E-6;

	cut34_si = 0.200;

	cut5_a = 0.1073; cut5_b = +2.5E-3; cut5_si = 17E-3;
	cut6_a = 0.1073; cut6_b = +7E-3; cut6_si = 17E-3;

	cut7_al = -13.9;
	cut7_c = 0E-3;	// now included in fine alignment
	cut7_si = 9E-3;

	th_y_lcut_L = 23.8E-6; th_y_lcut_R = 23.5E-6;	
...
void Init_45t_56b()
{
	...
	cut5_a = 0.1073; cut5_b = +6.3E-3; cut5_si = 17E-3;
	cut6_a = 0.1073; cut6_b = 14.5E-3; cut6_si = 17E-3;

	cut7_al = -16.0;
	cut7_c = 0E-3;	// now included in fine alignment
	cut7_si = 9E-3;

	th_y_lcut_L = 24.0E-6; th_y_lcut_R = 23.2E-6;	
